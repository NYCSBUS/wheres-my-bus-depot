            ...
            try:
                ...
                if device_statuses:
                    ...
                    if bus_lat and bus_lon:
                        ...
                        m = folium.Map(location=map_center, zoom_start=18, tiles=f"https://api.mapbox.com/styles/v1/vr00n-nycsbus/cm0404e2900bj01qvc6c381fn/tiles/256/{{z}}/{{x}}/{{y}}@2x?access_token={mapbox_token}", attr="Mapbox")
